...
dir_data="../Data/";dir_files="Rosario_period/"
...
date_list,ozono_list=np.loadtxt(dir_data+"data_OMI_OMT03.dat",skiprows=lim_i,unpack=True,usecols=[0,11],dtype=str,max_rows=lim_f-lim_i)
