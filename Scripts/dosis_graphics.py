...
dates, time_vitamin, time_med = np.loadtxt(
    dir_data+"dosis_time.csv", delimiter=",", unpack=True, skiprows=1)
days = 366
...
plt.fill_between(np.arange(days), time_vitamin,
                 time_med, color="#E7CA01", alpha=0.5)
lim, div = 90, 10
...
plt.subplots_adjust(left=0.12, bottom=0.11, right=0.952,
                    top=0.912, hspace=0.248)
