...
x=np.arange(n_days)
plt.scatter(x,data_vitamin,c="#0B0033",label="Modelo TUV",marker=".")
plt.scatter(x,data_Herman,c="#370031",label="Herman, 2010",marker=".")
plt.scatter(x[data_CIE!=0],data_CIE[data_CIE!=0],c="#832232",label="CIE-2014",marker=".")
