...
\titulo{ANÁLISIS DE TRES MÉTODOS DE DERIVACIÓN DE LA IRRADIANCIA SOLAR EFECTIVA PARA LA SÍNTESIS DE PRE-VITAMINA D\textsubscript{3} EN LA PIEL, EN LA CIUDAD DE ROSARIO, ARGENTINA}{ANALYSIS OF THREE DERIVATION METHODS OF EFFECTIVE SOLAR IRRADIANCE FOR THE SYNTHESIS OF PRE-VITAMIN D\textsubscript{3} ON THE SKIN, IN ROSARIO, ARGENTINA}
...
\begin{table*}[ht]
  ...
  \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
    \hline
    Ciudad                     & \multicolumn{4}{c|}{\begin{tabular}[c]{@{}c@{}}Cabrera 2005\\ fototipo III, \\ Dosis=210 J/m$^2$ \end{tabular}} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}Diaz et al. 2011\\ fototipo II, \\ Dosis=250 J/m$^2$ \end{tabular}} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}Presente\\ fototipo II, \\ Dosis=250 J/m$^2$ \end{tabular}}                                                                                                              \\ \cline{2-9}
