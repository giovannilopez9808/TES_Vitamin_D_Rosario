...
\begin{table*}[ht]
  ...
  \end{tabular}
  \caption{TES obtenidos por Cabrera 2005\cite{cabrera_radiacion_2005}, Diaz et al. 2011\cite{Diaz2011} (gris) y análisis presente con modelo TUV (blanco): tasa de dosis (W/m$^2$), fototipo y dosis eritémica mencionada por cada autor.}
  \label{table:TES}
\end{table*}
